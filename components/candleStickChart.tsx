...
const CandleStickChart = ({
  ...
  const [isPending, startTransition] = useTransition(); // For handling transitions TODO: need to learn more about this
  ...
  const fetchOHLCData = async (selectedPeriod: Period) => {
    ...
    try {
      ...
      const newData = await fetcher<OHLCData[]>(`/coins/${coinId}/ohlc`, {
        ...
        days: config.days, // You can change this to the desired number of days
